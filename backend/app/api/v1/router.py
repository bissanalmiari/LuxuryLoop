...
from app.api.v1.routes import auth_routes, admin_auth, reference_data, product, inventory, consignment, cart, order, staff, reports, favorites, newsletter, contact
